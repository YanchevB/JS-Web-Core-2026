...
let maybeCar3 = { engine: { horsepower: 250 }, tires: { model: 'Nie' } }; let maybeCar4 = { engine: { horsepower: 220, type: 'electric' }, tires: { model: 'BRIT' }, body: { material: 'steel', weight: 2670 } }; 
